 ...
 * // UniqueEntity permet de vérifier l'existence de doublon
 * @UniqueEntity(
 * fields={"title"},
...
class Ad
{
     ...
     * @Assert\Length(min=4, max=255,minMessage="Le titre doit faire 4 caractères minimum !", maxMessage="Le titre ne peut pas faire plus de 255 caractères")
     */
    private $title;
